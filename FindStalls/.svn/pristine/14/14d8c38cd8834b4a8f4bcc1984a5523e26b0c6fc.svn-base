...
#define kMinHeigth 80.0

@interface SendGoods0TableViewCell()<UITextViewDelegate>
@property (nonatomic, strong) UIView* bgView;

@end
@implementation SendGoods0TableViewCell
...
{
    SendGoods0TableViewCell *cell = [self dequeueReusableCellWithIdentifier:cellId];
    
    if (cell == NULL) {
        cell = [[SendGoods0TableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellId];
