//
//  MyBookedDetailViewController.m
//  FindStalls
//
...
@interface MyBookedDetailViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation MyBookedDetailViewController
...
- (void)createTableView{
    ...
    tableBg.backgroundColor = [MyController colorWithHexString:@"f4f4f4"];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (0 == indexPath.section) {
        ...
        OrderDetail1Model *model = self.dataSource[indexPath.row];
    ...
    MyBookedDetail3TableViewCell* cell0 = [[MyBookedDetail3TableViewCell alloc] init];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    if(0 == indexPath.section){
        ...
        OrderAllModel* model = self.dataSource1[indexPath.row];
        ...
        OrderAll1Model* model = self.dataSource2[indexPath.row];
    ...
    OrderDetail4Model* model = self.dataSource3[indexPath.row];
    return [MyBookedDetail3TableViewCell hyb_heightForIndexPath:indexPath config:^(UITableViewCell *sourceCell) {
        MyBookedDetail3TableViewCell *cell = (MyBookedDetail3TableViewCell *)sourceCell;
        // 配置数据
        [cell configCellWithModel:model];
    }];
}
...
- (void)makeData{
    ...
    [self.dataSource3 addObject:model4];
