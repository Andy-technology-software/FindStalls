...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName:[MyController colorWithHexString:NAVTITCOLOR],NSFontAttributeName:[UIFont systemFontOfSize:19.0]}];
